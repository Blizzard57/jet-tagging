...
Decay_b = Decay(name = 'Decay_b',
                ...
                partial_widths = {(P.W__minus__,P.t):'(((3*ee**2*MB**2)/(2.*sw**2) + (3*ee**2*MT**2)/(2.*sw**2) + (3*ee**2*MB**4)/(2.*MW**2*sw**2) - (3*ee**2*MB**2*MT**2)/(MW**2*sw**2) + (3*ee**2*MT**4)/(2.*MW**2*sw**2) - (3*ee**2*MW**2)/sw**2)*cmath.sqrt(MB**4 - 2*MB**2*MT**2 + MT**4 - 2*MB**2*MW**2 - 2*MT**2*MW**2 + MW**4))/(96.*cmath.pi*abs(MB)**3)',
                                  (P.lq,P.vt__tilde__):'((MB**2 - Mlq**2)*(3*LM33L**2*MB**2 - 3*LM33L**2*Mlq**2 + 6*LM23L*LM33L*MB**2*Vcb - 6*LM23L*LM33L*Mlq**2*Vcb + 3*LM23L**2*MB**2*Vcb**2 - 3*LM23L**2*Mlq**2*Vcb**2))/(96.*cmath.pi*abs(MB)**3)'})
...
Decay_lq = Decay(name = 'Decay_lq',
                 particle = P.lq,
                 partial_widths = {(P.b,P.vt):'((-MB**2 + Mlq**2)*(-3*LM33L**2*MB**2 + 3*LM33L**2*Mlq**2 - 6*LM23L*LM33L*MB**2*Vcb + 6*LM23L*LM33L*Mlq**2*Vcb - 3*LM23L**2*MB**2*Vcb**2 + 3*LM23L**2*Mlq**2*Vcb**2))/(48.*cmath.pi*abs(Mlq)**3)',
                                   (P.c,P.ta__minus__):'((Mlq**2 - MTA**2)*(3*LM23L**2*Mlq**2 + 3*LM23R**2*Mlq**2 - 3*LM23L**2*MTA**2 - 3*LM23R**2*MTA**2 + 6*LM23L*LM33L*Mlq**2*Vcb - 6*LM23L*LM33L*MTA**2*Vcb + 3*LM33L**2*Mlq**2*Vcb**2 - 3*LM33L**2*MTA**2*Vcb**2))/(48.*cmath.pi*abs(Mlq)**3)',
                                   (P.d,P.vt):'(LM23L**2*Mlq**4*Vcd**2)/(16.*cmath.pi*abs(Mlq)**3)',
                                   (P.s,P.vt):'(LM23L**2*Mlq**4*Vcs**2)/(16.*cmath.pi*abs(Mlq)**3)',
                                   (P.ta__minus__,P.u):'((Mlq**2 - MTA**2)*(3*LM33L**2*Mlq**2*Vub**2 - 3*LM33L**2*MTA**2*Vub**2))/(48.*cmath.pi*abs(Mlq)**3)',
                                   (P.t,P.ta__minus__):'((3*LM33L**2*Mlq**2*Vtb**2 - 3*LM33L**2*MT**2*Vtb**2 - 3*LM33L**2*MTA**2*Vtb**2)*cmath.sqrt(Mlq**4 - 2*Mlq**2*MT**2 + MT**4 - 2*Mlq**2*MTA**2 - 2*MT**2*MTA**2 + MTA**4))/(48.*cmath.pi*abs(Mlq)**3)'})
...
Decay_t = Decay(name = 'Decay_t',
                ...
                partial_widths = {(P.W__plus__,P.b):'(((3*ee**2*MB**2)/(2.*sw**2) + (3*ee**2*MT**2)/(2.*sw**2) + (3*ee**2*MB**4)/(2.*MW**2*sw**2) - (3*ee**2*MB**2*MT**2)/(MW**2*sw**2) + (3*ee**2*MT**4)/(2.*MW**2*sw**2) - (3*ee**2*MW**2)/sw**2)*cmath.sqrt(MB**4 - 2*MB**2*MT**2 + MT**4 - 2*MB**2*MW**2 - 2*MT**2*MW**2 + MW**4))/(96.*cmath.pi*abs(MT)**3)',
                                  (P.lq,P.ta__plus__):'((-3*LM33L**2*Mlq**2*Vtb**2 + 3*LM33L**2*MT**2*Vtb**2 + 3*LM33L**2*MTA**2*Vtb**2)*cmath.sqrt(Mlq**4 - 2*Mlq**2*MT**2 + MT**4 - 2*Mlq**2*MTA**2 - 2*MT**2*MTA**2 + MTA**4))/(96.*cmath.pi*abs(MT)**3)'})

Decay_ta__minus__ = Decay(name = 'Decay_ta__minus__',
                          particle = P.ta__minus__,
                          partial_widths = {(P.lq,P.c__tilde__):'((-Mlq**2 + MTA**2)*(-3*LM23L**2*Mlq**2 - 3*LM23R**2*Mlq**2 + 3*LM23L**2*MTA**2 + 3*LM23R**2*MTA**2 - 6*LM23L*LM33L*Mlq**2*Vcb + 6*LM23L*LM33L*MTA**2*Vcb - 3*LM33L**2*Mlq**2*Vcb**2 + 3*LM33L**2*MTA**2*Vcb**2))/(32.*cmath.pi*abs(MTA)**3)',
                                            (P.lq,P.t__tilde__):'((-3*LM33L**2*Mlq**2*Vtb**2 + 3*LM33L**2*MT**2*Vtb**2 + 3*LM33L**2*MTA**2*Vtb**2)*cmath.sqrt(Mlq**4 - 2*Mlq**2*MT**2 + MT**4 - 2*Mlq**2*MTA**2 - 2*MT**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(MTA)**3)',
                                            (P.W__minus__,P.vt):'((MTA**2 - MW**2)*((ee**2*MTA**2)/(2.*sw**2) + (ee**2*MTA**4)/(2.*MW**2*sw**2) - (ee**2*MW**2)/sw**2))/(32.*cmath.pi*abs(MTA)**3)',
                                            (P.lq,P.u__tilde__):'((-Mlq**2 + MTA**2)*(-3*LM33L**2*Mlq**2*Vub**2 + 3*LM33L**2*MTA**2*Vub**2))/(32.*cmath.pi*abs(MTA)**3)'})
