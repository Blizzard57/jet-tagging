...
\begin{titlepage}
    ...
    \textsc{\Large ParticleNet}\\[0.5cm]
    \textsc{\large Jet Tagging via Particle Clouds}\\[0.5cm] % Minor heading such as course title
    \HRule \\[0.4cm]
    { \huge \bfseries Replication Study}\\[0.4cm]
    \HRule \\[1.5cm]
    \begin{minipage}{0.6\textwidth}
    \begin{flushleft} \large
    \emph{Author:} Jai Bardhan, Animesh Sinha, Kalp Shah
    \end{flushleft}
    \end{minipage}\\[2cm]
    {\large \today}\\[2cm]
    \vfill
...
\input{tex/simplify-particle-net.tex}
\input{tex/theory-ml-particlenet.tex}
