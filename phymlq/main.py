...
phymlq.data.tagging.TopTaggingDataset.transform_files("train")
phymlq.data.tagging.TopTaggingDataset.transform_files("val")
phymlq.data.tagging.TopTaggingDataset.transform_files("test")
